#ifndef COPY_ELISION_EMPLOYEE_H
#define COPY_ELISION_EMPLOYEE_H
...
public:
    ...
    Employee(Employee&&) = default; //disabled move constructor
    Employee& operator=(const Employee&) = delete; //deleted copy assignment operator
    Employee& operator=(Employee&&) = default; //c++ brand new, deleted move assignment operator
